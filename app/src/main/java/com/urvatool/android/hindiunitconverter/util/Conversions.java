...
import com.urvatool.android.hindiunitconverter.Preferences;
import com.urvatool.android.hindiunitconverter.R;
import com.urvatool.android.hindiunitconverter.api.models.Country;
...
import com.urvatool.android.hindiunitconverter.models.TemperatureUnit;
import com.urvatool.android.hindiunitconverter.models.Unit;
...
import static com.urvatool.android.hindiunitconverter.models.Unit.*;
...
public final class Conversions {
    ...
    private Conversions() {
        ...
        getRegistanceConversions();
        getImagesConversions();
        getForceConversions();
        getAngleConversions();
    ...
    private void getFuelConversions() {
        ...
        units.add(new Unit(lIT_M, R.string.l_m, 0.002352, 0.000016));
        units.add(new Unit(WH_KM, R.string.wh_km, 20940.209178, 20940.20917));
        units.add(new Unit(WH_M, R.string.wh_m, 33700.000000, 33700.000000));
    ...
    private void getPressureConversions() {
        ...
        units.add(new Unit(HECTOPASCAL, R.string.hectopascal, 100, 0.01));
    ...
    private void getSpeedConversions() {
        ...
        units.add(new Unit(M_M, R.string.m_m, 0.0166666667, 60));
        units.add(new Unit(KM_S, R.string.km_s, 1000, 0.001));
        units.add(new Unit(CM_H, R.string.cm_h, 0.0000027778, 360000));
        units.add(new Unit(CM_M, R.string.cm_m, 0.0001666667, 6000));
        units.add(new Unit(CM_S, R.string.cm_s, 0.01, 100));
    ...
    private void getTorqueConversions() {
        ...
        units.add(new Unit(N_CM, R.string.newton_centimeter, 0.01, 100));
        units.add(new Unit(N_MM, R.string.newton_millimeter, 0.001, 1000));
        units.add(new Unit(kN_M, R.string.kilo_newtons, 1000, 0.001));
        units.add(new Unit(dYN_M, R.string.dyne_meter, 0.00001, 100000));
        units.add(new Unit(FT_LBF, R.string.ft_lbF, 1.3558179483314004, 0.7375621494575464935503));
        units.add(new Unit(IN_LBF, R.string.in_lbF, 0.1129848290276167, 8.850745793490557922604));
    ...
    private void getCurrentConversions() {
        ...
        units.add(new Unit(KILOAMPERE, R.string.kiloampere, 1000.0,0.001000 ));
        units.add(new Unit(MILLIAMPERE, R.string.milliampere, 0.001,1000.000000 ));
        units.add(new Unit(BIOT, R.string.biot, 10,0.100000));
        units.add(new Unit(ABAMPERE, R.string.abampere, 10,0.100));
        units.add(new Unit(EMU, R.string.emu, 10,0.100000 ));
        units.add(new Unit(STATAAMPERE, R.string.stataampere, 0,2997924536.843143 ));
        units.add(new Unit(ESU, R.string.esu, 0.0,2997924536.843143));
        units.add(new Unit(CGS, R.string.cgs, 10,0.100));
        units.add(new Unit(CGSES, R.string.cgses, 0.0000000003,2997924536.800 ));
        addConversion(Conversion.CURRENT, new Conversion(Conversion.CURRENT, R.string.current, units));
    }


    private void getRegistanceConversions() {
        //Base unit: square metre
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(OHM, R.string.ohm, 1.0, 1.0));
        units.add(new Unit(NANOOHM, R.string.nanoohm, 0.0000000001,1000000000 ));
        units.add(new Unit(MICROOHM, R.string.microohm, 0.0000001,1000000  ));
        units.add(new Unit(MILLIOHM, R.string.milliohm, 0.0001 ,1000 ));
        units.add(new Unit(KILOOHM, R.string.kiloohm, 1000,0.0001));
        units.add(new Unit(MEGAOHM, R.string.megaohm, 1000000,0.0000001 ));
        units.add(new Unit(GIGAOHM, R.string.gigaohm, 1000000000,0.0000000001 ));

        addConversion(Conversion.RESISTANCE, new Conversion(Conversion.RESISTANCE, R.string.resistance, units));
    }

    private void getImagesConversions() {
        //Base unit: square metre
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(TWIP, R.string.twip, 0.01763886,56.693));
        units.add(new Unit(METER, R.string.meter, 1000,0.001));
        units.add(new Unit(CENTIMETER, R.string.centimeter, 10,0.1));
        units.add(new Unit(MILLIMETER, R.string.millimeter, 1.0,1.0));
        units.add(new Unit(CHARACTER_X, R.string.chacterx, 0.002118644,0.472));
        units.add(new Unit(CHARACTER_Y, R.string.chactery, 4.2372,0.236));
        units.add(new Unit(PIXEL_X, R.string.pixtelx, 0.2645502645,3.780));
        units.add(new Unit(PIXEL_Y, R.string.pixely, 0.2645502645,3.780));
        units.add(new Unit(EN, R.string.en, 0.175716042,5.691));
        addConversion(Conversion.IMAGE, new Conversion(Conversion.IMAGE, R.string.image, units));
    }

    private void getForceConversions() {
        // Base unit - Newton-metres
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(DYNES, R.string.dynes, 0.000010,100000));
        units.add(new Unit(KILOGRAMS_FORCE, R.string.kilograms_force, 9.806650,0.101972));
        units.add(new Unit(KILO_NEWTONS, R.string.kilo_newtons, 1000,0.001000));
        units.add(new Unit(MEGA_NEWTONS, R.string.mega_newtons, 1000000,0.000001));
        units.add(new Unit(KIPS, R.string.kips, 4448.222000,0.000225));
        units.add(new Unit(NEWTONS, R.string.newton, 1.0,1.0));
        units.add(new Unit(POUNDS_FORCE, R.string.pounds_force, 4.448222,0.224809));
        units.add(new Unit(POUNDALS, R.string.poundals, 0.138255,7.233011));
        units.add(new Unit(STHENE, R.string.sthene, 1000,0.001000));
        units.add(new Unit(TONNES_FORCE, R.string.tonnes_force, 9806.650000,0.000102));
        addConversion(Conversion.FORCE, new Conversion(Conversion.FORCE, R.string.force, units));
    }

    private void getAngleConversions() {
        // Base unit - Newton-metres
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(DEGREE, R.string.degree, 0.000010,100000));
        units.add(new Unit(RADIAN, R.string.radian, 9.806650,0.101972));
        units.add(new Unit(GRAD, R.string.grad, 1000,0.001000));
        units.add(new Unit(A_MINUTE, R.string.a_minuit, 1000000,0.000001));
        units.add(new Unit(A_SECOND, R.string.a_second, 4448.222000,0.000225));
        units.add(new Unit(GON, R.string.gon, 1.0,1.0));
        units.add(new Unit(SIGN, R.string.sign, 4.448222,0.224809));
        units.add(new Unit(MIL, R.string.mil, 0.138255,7.233011));
        units.add(new Unit(REVOLUTION, R.string.revolution, 1000,0.001000));
        units.add(new Unit(CIRCLE, R.string.circle, 9806.650000,0.000102));
        units.add(new Unit(TURN, R.string.turn, 4.448222,0.224809));
        units.add(new Unit(QUADRANT, R.string.quadrant, 0.138255,7.233011));
        units.add(new Unit(RIGHT_ANGLE, R.string.right_angle, 1000, 0.001000));
        units.add(new Unit(SEXTANT, R.string.sextant, 9806.650000,0.000102));
        addConversion(Conversion.ANGLE, new Conversion(Conversion.ANGLE, R.string.angle, units));
    }

    private void getFrequencyConversions() {
        //Base Unit - hertz
        List<Unit> units = new ArrayList<Unit>();
        units.add(new Unit(HERTZ, R.string.hertz, 1.0, 1.0));
        units.add(new Unit(NANOHERTZ, R.string.nanohertz, 0.0000000001, 1000000000));
        units.add(new Unit(MICROHERTZ, R.string.microhertz, 0.0000001, 1000000 ));
        units.add(new Unit(MILLHERTZ, R.string.millihertz, 0.0001, 1000 ));
        units.add(new Unit(GIGAHERTZ, R.string.gigahertz, 1000000000, 0.0000000001));
        units.add(new Unit(KILOHERTZ, R.string.kilohertz, 1000, 0.001));
        units.add(new Unit(MEGAHERTZ, R.string.megahertz, 1000000, 0.000001));
        units.add(new Unit(GIGAHERTZ, R.string.gigahertz, 1000000000, 0.0000000001));
        addConversion(Conversion.FREQUENCY, new Conversion(Conversion.FREQUENCY, R.string.frequency, units));
    }
